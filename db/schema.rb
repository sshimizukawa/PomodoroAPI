...
ActiveRecord::Schema.define(version: 2021_10_06_193110) do
  ...
  create_table "music_links", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_music_links_on_user_id"
  end

  create_table "music_sessions", force: :cascade do |t|
    t.integer "length", default: 300000, null: false
  ...
  add_foreign_key "music_links", "users"
